    ...
    <div className="space-y-8 my-8">
      ...
      <div className="sketch-card p-6 sm:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 font-mono text-xs">
          {/* REST Routes */}
          <div className="p-3.5 sm:p-4 rounded-xl bg-gradient-to-br from-[#fffef5] to-[#fff8e6]">
            <span className="font-bold text-[#ff5e5b] block mb-3 text-[10px] uppercase tracking-wider">RESOURCE-ORIENTED ROUTES</span>
            <div className="space-y-2">
              <div className="stripe-card stripe-card-green p-2 flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                <span className="text-green-700 font-bold">POST /orders</span>
                <span className="text-gray-500 text-xs">Create new order (201)</span>
              </div>
              <div className="stripe-card stripe-card-blue p-2 flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                <span className="text-blue-700 font-bold">GET /orders/:id</span>
                <span className="text-gray-500 text-xs">Retrieve order spec (200)</span>
              </div>
              <div className="stripe-card stripe-card-amber p-2 flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                <span className="text-amber-700 font-bold">PATCH /orders/:id</span>
                <span className="text-gray-500 text-xs">Update status / address</span>
              </div>
              <div className="stripe-card p-2 flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                <span className="text-red-700 font-bold">DELETE /orders/:id</span>
                <span className="text-gray-500 text-xs">Cancel pending order</span>
              </div>
            </div>
          </div>
...
{`{
  ...
  "timestamp": "2026-08-17T14:50:00Z"
      ...
      <div className="sketch-card p-6 sm:p-8">
        ...
        <div className="p-4 bg-[#f6f4ee] sketch-border-sm mb-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 font-mono text-xs">
            ...
            <ArrowRight className="w-4 h-4 text-[#ff5e5b]" />
            <div className="p-3 bg-white text-center bg-[#ffe866]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 font-mono text-xs">
          <div className="metric-tile p-3">
            <span className="font-bold text-[#ff5e5b] block mb-1 text-[10px] uppercase tracking-wider">INDEXING</span>
            <span className="text-[11px] text-gray-300">B-Tree indexes on FKs & query predicates</span>
          </div>
          <div className="metric-tile p-3">
            <span className="font-bold text-[#3498db] block mb-1 text-[10px] uppercase tracking-wider">LOCKING</span>
            <span className="text-[11px] text-gray-300">SELECT FOR UPDATE row-level locks</span>
          </div>
          <div className="metric-tile p-3">
            <span className="font-bold text-[#2ecc71] block mb-1 text-[10px] uppercase tracking-wider">TRANSACTIONS</span>
            <span className="text-[11px] text-gray-300">ACID guarantees across multi-row mutations</span>
          </div>
          <div className="metric-tile p-3">
            <span className="font-bold text-amber-400 block mb-1 text-[10px] uppercase tracking-wider">CONSTRAINTS</span>
            <span className="text-[11px] text-gray-300">Foreign keys & unique indexes</span>
          </div>
        </div>
      </div>
      ...
      <div className="sketch-card p-6 sm:p-8">
        ...
        <div className="p-5 rounded-xl bg-gradient-to-br from-[#fffef5] to-[#fef9e7]">
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 font-mono text-xs">
            <div className="raised-card p-3">
            ...
            <div className={`p-3 rounded-lg border ${
              ...
              <span className="text-[10px] font-bold block text-gray-500">STEP 3</span>
              <span className="font-bold text-[#1e1d1b]">3. Charge Payment</span>
          ...
          <div className={`mt-4 p-3 stripe-card font-mono text-xs ${
            paymentStatus === "SUCCESS" ? "stripe-card-green" : "stripe-card"
          }`}>
      ...
      <div className="sketch-card p-6 sm:p-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2 font-mono text-xs">
          <div className="raised-card p-2.5 text-center border-t-4 border-amber-500">
            <span className="font-bold text-amber-900 block">400</span>
            <span className="text-[10px] text-[#57534e]">Validation</span>
          </div>
          <div className="raised-card p-2.5 text-center border-t-4 border-red-500">
            <span className="font-bold text-red-900 block">401</span>
            <span className="text-[10px] text-[#57534e]">Unauthenticated</span>
          </div>
          <div className="raised-card p-2.5 text-center border-t-4 border-purple-500">
            <span className="font-bold text-purple-900 block">403</span>
            <span className="text-[10px] text-[#57534e]">Unauthorized</span>
          </div>
          <div className="raised-card p-2.5 text-center border-t-4 border-gray-400">
            <span className="font-bold text-gray-700 block">404</span>
            <span className="text-[10px] text-[#57534e]">Not Found</span>
          </div>
          <div className="raised-card p-2.5 text-center border-t-4 border-orange-500">
            <span className="font-bold text-orange-900 block">409</span>
            <span className="text-[10px] text-[#57534e]">Conflict</span>
          </div>
          <div className="raised-card p-2.5 text-center border-t-4 border-rose-500">
            <span className="font-bold text-rose-900 block">429</span>
            <span className="text-[10px] text-[#57534e]">Rate Limited</span>
          </div>
          <div className="metric-tile p-2.5 text-center">
            <span className="font-bold text-[#ff5e5b] block">500</span>
            <span className="text-[10px] text-gray-400">Server Error</span>
          </div>
        </div>
      </div>
    </div>
